...
class _DiscoverScreenState extends State<DiscoverScreen> {
  ...
  void initState() {
    ...
    if (!AnalyticsService.isTestMode) {
    ...
    return BlocBuilder<AuthBloc, AuthState>(
      builder: (context, authState) {
        ...
        if (!_favoritesLoaded) {
          ...
          // ИСПРАВЛЕНИЕ: Не вызываем OnlineStatusService в тестовом режиме
          if (!AnalyticsService.isTestMode) {
            OnlineStatusService.setOnline();
          }
        }
                ...
                SizedBox(
                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      const SizedBox(width: 8),
                      _CategoryChip(icon: Icons.ac_unit, label: 'Суккуленты'),
                      const SizedBox(width: 8),
                      _CategoryChip(icon: Icons.eco, label: 'Экзотика'),
                      const SizedBox(width: 8),
                      _CategoryChip(icon: Icons.eco, label: 'Экзотика1'),
                      const SizedBox(width: 8),
                      _CategoryChip(icon: Icons.eco, label: 'Экзотика2'),
                      const SizedBox(width: 8),
                      _CategoryChip(icon: Icons.eco, label: 'Экзотика3'),
                      const SizedBox(width: 8),
                    ],
                  ),
                ),
